...
<table class="tabconfirmacion" width="35%" align="center" border="2">
        <tr>
          <td colspan="2" align="center">
<?php
  try{
    $sql="SELECT * FROM tipopescado WHERE idtipo =".$_REQUEST['codigo'].";";
    $resultado=$base->prepare($sql);
    $resultado->execute(array());
    while($consulta=$resultado->fetch(PDO::FETCH_ASSOC)){
      echo "Está seguro de que desea eliminar de la Base de Datos el Tipo de pescado: ".$consulta['especie'];
      }
    }catch(Exeption $e){
...
?>
<tr>
    <td align="center"> Confirmar</td>
    <td align="center"> Cancelar</td>
</tr>
<tr>  
    <td>
    <a href="eli_tipo.php?eliminar= <?php echo $_REQUEST['codigo'] ?>"><img style="padding-left: 35%" src="img/confirmar.jpg" width="55%"></a>
    </td>
    <td>
      <a href="javascript:history.go(-1)"><img style="padding-left: 45%" src="img/cancelar.png" width="55%"></a>
    </td>
  </tr>
</table>
