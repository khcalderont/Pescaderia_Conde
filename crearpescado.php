...
<center>
  <form method="POST" name="form" id="formu">
        <table class="tabcen" align="center">

            <tr>
              <td colspan="2" align="center"><h2><strong>FORMULARIO REGISTRO DE PESCADO</strong></h2></td>
            </tr>
                 <tr>
          <td class="negrita">
          ...
          <td>
          <input type="number" name="pes" placeholder="Peso" required="">
        </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="number" name="canti" placeholder="Cantidad" required="">
        </td>
        </tr>
        <tr>
        <td class="negrita">
        ...
        <tr>
          ...
          <td>
          <input type="number" name="valorc" placeholder="Valor de compra" required="">
        </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="number" name="valorv" placeholder="Valor de venta" required=""> 
        </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="date" name="fecha" placeholder="Fecha de ingreso" required="">
        </td>
        </tr>
        <tr>
          <td colspan="2" align="center"><input id="boton" type="submit" name="btn" value="Enviar"></td>
        </tr>
      </table>
    </form>
    </center>
   ...
   if(isset($_POST['btn'])){
    ...
    try{
      $sql="INSERT INTO pescado(`lote`, `pesopromedio`, `cantidad`, `fk_tipo`, `valorcompra`, `valorventa`, `fechaingreso`) VALUES ('',:pe,:cant,:esp,:valc,:valv,:fec)";
    ...
    ?>
    <script language="javascript"> window.alert("Registro de pescado exitoso !!")</script>
