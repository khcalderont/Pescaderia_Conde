...
<?php
  try{
    $sql="SELECT * FROM pescado WHERE lote =".$_REQUEST['codigo'].";";
    $resultado=$base->prepare($sql);
    $resultado->execute(array());
    while($consulta=$resultado->fetch(PDO::FETCH_ASSOC)){
      echo "Está seguro de que desea eliminar de la Base de Datos el registro de pescado seleccionado..?";
      }
    }catch(Exeption $e){
...
<tr>
  ...
  <tr>  
    <td>
    <a href="eli_pescado.php?eliminar= <?php echo $_REQUEST['codigo'] ?>"><img style="padding-left: 35%" src="img/confirmar.jpg" width="55%"></a>
    </td>
    <td>
