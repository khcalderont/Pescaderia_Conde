...
<center>
  <form method="POST" name="form" id="formu">
        <table class="tabcen" align="center">
            ...
            <tr>
              <td colspan="2" align="center"><h2><strong>FORMULARIO REGISTRO DE TIPO DE PESCADO</strong></h2></td>
            </tr>
            <tr>
          <td class="negrita">
          ...
          <td>
          <input type="text" name="txt1" placeholder="Ingrese el tipo de pescado" required="">
          </td>
          <tr>
          <td colspan="2"><input id="boton" type="submit" name="btn" value="Enviar"></td>
        </tr>
      </table>
    </form>
    </center>
        <?php
            ...
            $sql="INSERT INTO tipopescado(`idtipo`, `especie`) VALUES ('',:ntip)" ;

            $resultado= $base->prepare($sql);
            $resultado->execute(array(":ntip"=>$tipo_pescado));
            ?>
            <script language="javascript">
            window.alert("El tipo de pez se ha registrado con éxito")
            </script>
