...
<td colspan="10">
        <form method="POST" action="" name="frmb">
          <input type="text" name="txtb" required="" placeholder="Nombre de la especie">
...
<tr>
  <td colspan="5" align="center" he><h1><strong>TIPO DE PESCADO REGISTRADO</strong></h1></td>
</tr>
<tr>
  <td align="center" width="75"><strong>Id Tipo</strong> </td>
  <td align="center" width="90"><strong>Especie</strong></td>
  <td align="center"><strong>Modificar</strong></td>
  <td align="center"><strong>Eliminar</strong></td>
</tr>
   <?php
try{
  $sqlb="SELECT * FROM tipopescado WHERE  especie=?";
  ...
  if ($contador==0) {
    ...
    <script language="javascript">window.alert("No se han encontrado coincidencias");window.location='contipo.php'</script>
  ...
  while ($consulta=$resultado->fetch(PDO::FETCH_ASSOC)) {
    ?>
    <tr>
    <td><?php echo $consulta['idtipo']; ?></td>
    <td><?php echo $consulta['especie']; ?></td>
    <td align="center"><a href="act_tipo.php?cod=<?php echo $consulta['idtipo']?>"><img src="img/editar.png" width="25" class="iconos"></a></td>
    <td align="center"><a href="confirtipo.php?codigo=<?php echo $consulta['idtipo']?>"><img src="img/eliminar.png" width="25" class="iconos"></a></td>
    </tr>
     <?php
  }
...
<tr>
  ...
  <td align="center"><strong>Eliminar</strong></td>
   ...
   <?php
  try{$sql='SELECT * FROM tipopescado';
  ...
  while ($consulta=$resultado->fetch(PDO::FETCH_ASSOC)) {
    ?>
    <tr>
    <td align="center"><?php echo $consulta['idtipo']; ?></td>
    <td><?php echo $consulta['especie']; ?></td>
    <td align="center"><a href="act_tipo.php?cod=<?php echo $consulta['idtipo']?>"><img src="img/editar.png" width="25" class="iconos"></a></td>
    <td align="center"><a href="confirtipo.php?codigo=<?php echo $consulta['idtipo']?>"><img src="img/eliminar.png" width="25" class="iconos"></a></td>
    </tr>
