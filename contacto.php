...
<center>
  <form method="POST" name="form" id="formu">
        <table class="tabcen" align="center">
            ...
            <tr>
              <td colspan="2"><h1><strong>FORMULARIO DE CONTACTO</strong></h1></td>
            </tr>
            <tr>
          <td class="negrita">
            <label>Nombre:</label>
          ...
          <td>
          <input type="text" name="" placeholder="Nombres y Apellidios" required="">
        </td>
        <tr>
          <td class="negrita">
            <label>E-Mail:</label>
          ...
          <td>
          <input type="email" name="" placeholder="ejemplo@gmail.com" required="">
        </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="text" name="" placeholder="Número de teléfono" required="">
          </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="text" name="" placeholder="Ciudad" required="">
        </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="text" name="" placeholder="Dirección" required=""> 
        </td>
        </tr>
        <tr>
          <td class="negrita">
          ...
          <td>
          <input type="text" name="" placeholder="Escribe aquí tu mensaje" required="">
        </td>
        </tr>
        <tr>
